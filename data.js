...
// อัพเดทล่าสุด: 04 ก.ย. 2569 (ใบรายงานผลงานประจำวันผู้รับจ้าง 28 ก.ค.–04 ก.ย. 2569, Google Drive inbox)
// buildInfo: rebuilt 06 ก.ย. 2569 (อัพเดต 903 cycle)
//   - Records 1-35 (28 ก.ค.-31 ส.ค.): คัดลอกจาก data.js เดิมบน GitHub ไม่มีการแก้ไข
//   - Records 36-39 (1-4 ก.ย.): เพิ่มใหม่รอบนี้ จาก Report 01-9-69.pdf, 02-9-69.pdf, 03-9-69.pdf, 04-9-69.pdf
//     chain-validate: เสาเข็ม 697→724→744→744 | PVC 618→642→642→642 | AC 755→755→825→900
//     | ผลิตหัว Support 554→563→563→563 | ติดตั้ง Support 435→435→435→435 (นิ่งทั้ง 4 วัน) — ทุกจุดสอดคล้อง chain
//   - Record 1 ก.ย.: PVC +24 ม. (618→642 ✓, STA.0-090--0-066 ก่อนจุดเริ่มต้นสัญญา)
//   - Record 2 ก.ย.: เสาเข็ม +27 ต้น (697→724 ✓), ผลิตหัว Support +9 (554→563 ✓), ท่อ AC เข้าหน่วยงาน 30 ท่อน (ยังไม่วาง)
//   - Record 3 ก.ย.: เสาเข็ม +20 ต้น (724→744 ✓), AC +70 ม. (755→825 ✓), ST +1 ม. (52→53 ✓),
//     ท่อบายพาส HDPE 49.1 ม. STA.2+850-2+900 (งานชั่วคราว) — ⚠ แถวสรุปสะสม HDPE ในรายงานแสดง 0/0 ไม่สะท้อนปริมาณนี้ ต้องยืนยัน C7
//   - Record 4 ก.ย.: AC +75 ม. (825→900 ✓) — รายการอื่นนิ่งทุกจุด
...
// ⚠ ประเด็นเฝ้าระวัง ณ 04 ก.ย. 2569: การติดตั้ง Support ยังนิ่งต่อเนื่องที่ 435 หัว มาแล้ว 7 วันปฏิทิน (29 ส.ค.–4 ก.ย.)
//   ขณะผลิตหัว Support เดินหน้าต่อ (554→563) — ส่วนต่างผลิต-ติดตั้งขยับกว้างขึ้นเป็น 128 หัว (563 ผลิต vs 435 ติดตั้ง)
//   เทียบกับ 119 หัว ณ 31 ส.ค. แนวโน้มคอขวดขั้นตอนติดตั้งหน้างานยังไม่คลี่คลาย ควรสอบถามแผนแก้ไข (Recovery Plan)
//   จากผู้จัดการสนาม (นายสมเกียรติ) เป็นลายลักษณ์อักษรก่อนการประชุมคณะกรรมการครั้งถัดไป
//   บันทึกเดิม (26-28 ส.ค.) ยังคง unconfirmed รอยืนยัน C7 ตามเดิม — เพิ่ม record 3 ก.ย. เป็น unconfirmed ใหม่ (ประเด็น HDPE ด้านบน)

const PID903_ASOF = "04 ก.ย. 2569";

const PID903_PIPES = {
  PVC: { laidM: 642 },
  AC:  { pileCount: 744, supportCount: 435, laidM: 900 }
};
