...
// อัพเดทล่าสุด: 07 ก.ย. 2569 (ใบรายงานผลงานประจำวันผู้รับจ้าง 28 ก.ค.–07 ก.ย. 2569, Google Drive inbox)
// buildInfo: rebuilt 08 ก.ย. 2569 (อัพเดต 903 cycle)
//   - Records 1-39 (28 ก.ค.-04 ก.ย.): คัดลอกจาก data.js เดิมบน GitHub ไม่มีการแก้ไข
//   - Records 40-42 (5-7 ก.ย.): เพิ่มใหม่รอบนี้ จาก Report 05-9-69.pdf, 06-9-69.pdf, 07-9-69.pdf
//     chain-validate: เสาเข็ม 744→744→744 (นิ่ง) | PVC 642→642→642 (นิ่ง) | AC laidM 900→900→900 (นิ่ง)
//     | ST 53→53→58 (+5 วันที่ 7 ก.ย. สอดคล้อง chain) | ผลิตหัว Support 563→563→563 (นิ่ง)
//   - Record 5 ก.ย.: ไม่มีผลงานก่อสร้างวันนี้ (รายงานระบุ "วันนี้ไม่มีการดำเนินงาน") — มีเฉพาะท่อ PVC Ø300 เข้าหน่วยงาน 41 ท่อน (ของเข้าไซต์ ไม่ใช่ท่อที่วางแล้ว)
//   - Record 6 ก.ย.: ขุดสำรวจงานวางท่อ Ø300 มม. STA.3+570 (งานสำรวจ ไม่มีปริมาณสะสมเปลี่ยนแปลง)
//   - Record 7 ก.ย.: ขุดดินเตรียมวางท่อ ST Ø300 มม. STA.2+050-1+995 5 ม. (สะสม 53→58 ✓ สอดคล้อง chain)
//     · ติดตั้งหัว Support รับ AC Ø300 มม. STA.3+370-3+375 — รายงานระบุ "วันนี้" 23 หัว แต่ "สะสม" แสดง 448 หัว
//     ⚠ ไม่สอดคล้อง chain: ฐานเดิม 435 + วันนี้ 23 = 458 ควรเป็น แต่รายงานสะสมแสดง 448 (ผลต่าง -10)
//     ยึดตัวเลขสะสมตามรายงาน (448) ตามหลัก "คอลัมน์สะสมเป็นตัวตั้ง" แต่ตั้ง unconfirmed:true รอยืนยัน C7
// ⚠ ประเด็นเฝ้าระวัง ณ 07 ก.ย. 2569: ส่วนต่างผลิต-ติดตั้งหัว Support ยึดตามตัวเลขสะสมล่าสุดคือ 563 ผลิต vs 448 ติดตั้ง
//   (ส่วนต่าง 115 หัว) แคบลงจาก 128 หัว ณ 4 ก.ย. แต่ตัวเลขติดตั้งวันที่ 7 ก.ย. ยังไม่ยืนยัน C7 จึงต้องระวังการตีความแนวโน้มนี้
//   จนกว่าจะตรวจสอบกับต้นฉบับ ควรสอบถามแผนแก้ไข (Recovery Plan) จากผู้จัดการสนาม (นายสมเกียรติ) เป็นลายลักษณ์อักษรก่อนการประชุมคณะกรรมการครั้งถัดไป
...
const PID903_ASOF = "07 ก.ย. 2569";

const PID903_PIPES = {
  PVC: { laidM: 642 },
  AC:  { pileCount: 744, supportCount: 448, laidM: 900 }
};
...
const PID903_DAILY = [
  ...
  { date: "1 ก.ย. 2569", month: 9,
    segs: ["STA.0-090--0-066 (ท่อ PVC)", "STA.2+800-2+900 (เตรียมท่อบายพาส)", "STA.0+350-0+400 (ถางป่าเคลียร์พื้นที่)"],
    text: "วางท่อ PVC Ø300 มม. STA.0-090--0-066 24 ม. (สะสม 642 ม. — สอดคล้อง chain จากฐาน 618+24) · เตรียมงานวางท่อบายพาส HDPE STA.2+800-2+900 (งานเตรียม ไม่นับสะสมถาวร) · ถางป่าเคลียร์พื้นที่กดเสาเข็ม STA.0+350-0+400 (งานเตรียม) — เสาเข็ม/ท่อ AC/ท่อ ST/ผลิต-ติดตั้ง Support นิ่งทุกรายการ (697 ต้น / 755 ม. / 52 ม. / 554 / 435)",
    meters: 24, unconfirmed: false, reportUrl: "https://drive.google.com/file/d/143dN0j3vvqRDOj4e-cI8ElNkrrdO91m0/view?usp=drivesdk" },

  { date: "2 ก.ย. 2569", month: 9,
    segs: ["STA.0+350-0+400 (เสาเข็ม)", "ท่อ AC เข้าหน่วยงาน"],
    text: "กดเสาเข็มสี่เหลี่ยม STA.0+350-0+400 27 ต้น (สะสม 724 ต้น — สอดคล้อง chain จากฐาน 697+27) · ท่อ AC Ø300 มม. เข้าหน่วยงาน 30 ท่อน (ของเข้าไซต์ ไม่ใช่ท่อที่วางแล้ว) · ผลิตหัว Support +9 (สะสม 563) — ท่อ PVC/AC/ST/ติดตั้ง Support นิ่งทุกรายการ (642 ม. / 755 ม. / 52 ม. / 435 หัว)",
    meters: 0, unconfirmed: false, reportUrl: "https://drive.google.com/file/d/1TEecMafEOQ3Yzds-hhq0Wk2EmIw-iCLU/view?usp=drivesdk" },

  { date: "3 ก.ย. 2569", month: 9,
    segs: ["STA.0+410-0+450 (เสาเข็ม)", "STA.2+850-2+900 (ท่อบายพาส HDPE)", "STA.3+570 (ท่อโค้ง ST 90°)", "ท่อ AC Ø300"],
    text: "กดเสาเข็มสี่เหลี่ยม STA.0+410-0+450 20 ต้น (สะสม 744 ต้น — สอดคล้อง chain จากฐาน 724+20) · วางท่อบายพาส HDPE Ø300 มม. STA.2+850-2+900 49.1 ม. (งานชั่วคราว ไม่นับปริมาณสะสมท่อถาวร — ⚠ หมายเหตุ: แถวสรุปสะสม HDPE ในรายงานแสดง 0/0 ไม่สะท้อนปริมาณ 49.1 ม. นี้ ต้องยืนยัน C7) · วางท่อโค้ง ST 90 องศา STA.3+570 1 ม. (สะสม 53 ม. — สอดคล้อง chain จากฐาน 52+1) · วางท่อ AC Ø300 มม. 70 ม. (สะสม 825 ม. — สอดคล้อง chain จากฐาน 755+70) — ท่อ PVC/ผลิต-ติดตั้ง Support นิ่งทุกรายการ (642 ม. / 563 / 435)",
    meters: 71, unconfirmed: true, reportUrl: "https://drive.google.com/file/d/16e7ylAsB9ookRVc1xwngCqoXjdtg9GCq/view?usp=drivesdk" },

  { date: "4 ก.ย. 2569", month: 9,
    segs: ["STA.1+200-1+275 (ท่อ AC)"],
    text: "วางท่อ AC Ø300 มม. STA.1+200-1+275 75 ม. (สะสม 900 ม. — สอดคล้อง chain จากฐาน 825+75) — เสาเข็ม/ท่อ PVC/ท่อ ST/ผลิต-ติดตั้ง Support นิ่งทุกรายการ (744 ต้น / 642 ม. / 53 ม. / 563 / 435)",
    meters: 75, unconfirmed: false, reportUrl: "https://drive.google.com/file/d/1WClvTDyEi1w60H7_89LVbLAeKCn-p7oB/view?usp=drivesdk" }

  ,
  { date: "5 ก.ย. 2569", month: 9,
    segs: ["ท่อ PVC เข้าหน่วยงาน"],
    text: "วันนี้ไม่มีการดำเนินงานก่อสร้าง — มีเฉพาะท่อ PVC Ø300 มม. เข้าหน่วยงาน 41 ท่อน (ของเข้าไซต์ ไม่ใช่ท่อที่วางแล้ว) — เสาเข็ม/PVC/AC/ST/ผลิต-ติดตั้ง Support นิ่งทุกรายการ (744 ต้น / 642 ม. / 900 ม. / 53 ม. / 563 / 435)",
    meters: 0, unconfirmed: false, reportUrl: "https://drive.google.com/file/d/1TIX2pzSu0vqZZ7EXv2tGiYL7RyB6bCfo/view?usp=drivesdk" },

  { date: "6 ก.ย. 2569", month: 9,
    segs: ["STA.3+570 (ขุดสำรวจงานวางท่อ)"],
    text: "ขุดสำรวจงานวางท่อ Ø300 มม. STA.3+570 (งานสำรวจ ไม่นับปริมาณสะสม) — เสาเข็ม/PVC/AC/ST/ผลิต-ติดตั้ง Support นิ่งทุกรายการ (744 ต้น / 642 ม. / 900 ม. / 53 ม. / 563 / 435)",
    meters: 0, unconfirmed: false, reportUrl: "https://drive.google.com/file/d/1RgKev-j5F4aN_NWK9OlEQFOr9tPIf0sy/view?usp=drivesdk" },

  { date: "7 ก.ย. 2569", month: 9,
    segs: ["STA.2+050-1+995 (ขุดดินเตรียมวางท่อ ST)", "STA.3+370-3+375 (ติดตั้งหัว Support รับ AC)"],
    text: "ขุดดินเตรียมวางท่อ ST Ø300 มม. STA.2+050-1+995 5 ม. (สะสม 58 ม. — สอดคล้อง chain จากฐาน 53+5) · ติดตั้งหัว Support รับท่อ AC Ø300 มม. STA.3+370-3+375 — รายงาน \"วันนี้\" 23 หัว แต่ \"สะสม\" แสดง 448 หัว (ฐานเดิม 435+23=458 ที่คาด ไม่ตรงกับสะสมที่รายงาน ผลต่าง -10 หัว) ยึดตัวเลขสะสมตามรายงานไว้ก่อน รอยืนยัน C7 — เสาเข็ม/PVC/AC laidM นิ่งทุกรายการ (744 ต้น / 642 ม. / 900 ม.)",
    meters: 5, unconfirmed: true, reportUrl: "https://drive.google.com/file/d/1Uz2LFuJTrG5OkpBNMgmp8xGzB1KOTvGe/view?usp=drivesdk" }
